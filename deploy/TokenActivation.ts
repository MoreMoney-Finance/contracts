...
type OracleConfig = (primary: boolean, tokenAddress: string, record: TokenInitRecord, allTokens: Record<string, string>, hre: HardhatRuntimeEnvironment) => Promise<[string, any[]]>;
...
deploy.dependencies = ['DependencyController', 'OracleRegistry', 'TwapOracle', 'ChainlinkOracle', 'EquivalentScaledOracle', 'ProxyOracle', 'TwapOracle', 'UniswapV2LPTOracle'];
