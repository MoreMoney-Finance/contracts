...
const deploy: DeployFunction = async function ({
  ...
  const AltYieldYakAVAXStrategy2v2 = await deploy('AltYieldYakAVAXStrategy2v2', {
    from: deployer,
  ...
  await manage(deployments, AltYieldYakAVAXStrategy2v2.address, 'AltYieldYakAVAXStrategy2v2');
  await registerStrategy(deployments, AltYieldYakAVAXStrategy2v2.address);
  
};
deploy.tags = ['AltYieldYakAVAXStrategy2v2', 'avalanche'];
