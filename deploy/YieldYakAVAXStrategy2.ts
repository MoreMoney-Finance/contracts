...
const deploy: DeployFunction = async function ({
  ...
  const YieldYakAVAXStrategy2 = await deploy('YieldYakAVAXStrategy2', {
    from: deployer,
  ...
  await manage(deployments, YieldYakAVAXStrategy2.address, 'YieldYakAVAXStrategy2');
  await registerStrategy(deployments, YieldYakAVAXStrategy2.address);
  
};
deploy.tags = ['YieldYakAVAXStrategy2', 'avalanche'];
